...
type CustomResourceParameters struct {
	...
	// +kubebuilder:validation:Optional
	DcLauncher *string `json:"dcLauncher,omitempty" tf:"dc_launcher,omitempty"`
...
type CustomResourceSpec struct {
	...
	ForProvider     CustomResourceParameters `json:"forProvider"`
}

// CustomResourceStatus defines the observed state of CustomResource.
type CustomResourceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CustomResourceObservation `json:"atProvider,omitempty"`
}
...
// CustomResourceList contains a list of CustomResources
...
var (
	CustomResource_Kind             = "CustomResource"
	CustomResource_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CustomResource_Kind}.String()
	CustomResource_KindAPIVersion   = CustomResource_Kind + "." + CRDGroupVersion.String()
	CustomResource_GroupVersionKind = CRDGroupVersion.WithKind(CustomResource_Kind)
)
