...
type SolutionDistributableAncestorsObservation struct {
}

type SolutionDistributableAncestorsParameters struct {
...
type SolutionDistributableCatalogObservation struct {
}

type SolutionDistributableCatalogParameters struct {
...
type SolutionDistributableComponentMetaObservation struct {
}

type SolutionDistributableComponentMetaParameters struct {
...
type SolutionDistributableDistributableMetasObservation struct {
}

type SolutionDistributableDistributableMetasParameters struct {
...
type SolutionDistributableNrSourceObservation struct {
}

type SolutionDistributableNrSourceParameters struct {
...
type SolutionDistributableObservation struct {
}

type SolutionDistributableParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []SolutionDistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []SolutionDistributableCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []SolutionDistributableComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []SolutionDistributableDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []SolutionDistributableNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []SolutionDistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []SolutionDistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []SolutionDistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []SolutionDistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []SolutionDistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type SolutionDistributableParentObservation struct {
}

type SolutionDistributableParentParameters struct {
...
type SolutionDistributablePermissionResourcesObservation struct {
}

type SolutionDistributablePermissionResourcesParameters struct {
...
type SolutionDistributableReleaseObservation struct {
}

type SolutionDistributableReleaseParameters struct {
...
type SolutionDistributableTagsObservation struct {
}

type SolutionDistributableTagsParameters struct {
...
type SolutionDistributableVersionContextInterestedMosObservation struct {
}

type SolutionDistributableVersionContextInterestedMosParameters struct {
...
type SolutionDistributableVersionContextObservation struct {
}

type SolutionDistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []SolutionDistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []SolutionDistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type SolutionDistributableVersionContextRefMoObservation struct {
}

type SolutionDistributableVersionContextRefMoParameters struct {
...
// SolutionDistributableSpec defines the desired state of SolutionDistributable
type SolutionDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SolutionDistributableParameters `json:"forProvider"`
}

// SolutionDistributableStatus defines the observed state of SolutionDistributable.
type SolutionDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SolutionDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// SolutionDistributable is the Schema for the SolutionDistributables API
...
type SolutionDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SolutionDistributableSpec   `json:"spec"`
	Status            SolutionDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SolutionDistributableList contains a list of SolutionDistributables
type SolutionDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SolutionDistributable `json:"items"`
}

// Repository type metadata.
var (
	SolutionDistributable_Kind             = "SolutionDistributable"
	SolutionDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SolutionDistributable_Kind}.String()
	SolutionDistributable_KindAPIVersion   = SolutionDistributable_Kind + "." + CRDGroupVersion.String()
	SolutionDistributable_GroupVersionKind = CRDGroupVersion.WithKind(SolutionDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&SolutionDistributable{}, &SolutionDistributableList{})
}
