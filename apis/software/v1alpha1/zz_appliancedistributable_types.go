...
type ApplianceDistributableObservation struct {
}

type ApplianceDistributableParameters struct {
...
// ApplianceDistributableSpec defines the desired state of ApplianceDistributable
type ApplianceDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ApplianceDistributableParameters `json:"forProvider"`
}

// ApplianceDistributableStatus defines the observed state of ApplianceDistributable.
type ApplianceDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ApplianceDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// ApplianceDistributable is the Schema for the ApplianceDistributables API
...
type ApplianceDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              ApplianceDistributableSpec   `json:"spec"`
	Status            ApplianceDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ApplianceDistributableList contains a list of ApplianceDistributables
type ApplianceDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ApplianceDistributable `json:"items"`
}

// Repository type metadata.
var (
	ApplianceDistributable_Kind             = "ApplianceDistributable"
	ApplianceDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ApplianceDistributable_Kind}.String()
	ApplianceDistributable_KindAPIVersion   = ApplianceDistributable_Kind + "." + CRDGroupVersion.String()
	ApplianceDistributable_GroupVersionKind = CRDGroupVersion.WithKind(ApplianceDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&ApplianceDistributable{}, &ApplianceDistributableList{})
}
