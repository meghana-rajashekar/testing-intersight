...
type HyperflexDistributableAncestorsObservation struct {
}

type HyperflexDistributableAncestorsParameters struct {
...
type HyperflexDistributableCatalogObservation struct {
}

type HyperflexDistributableCatalogParameters struct {
...
type HyperflexDistributableComponentMetaObservation struct {
}

type HyperflexDistributableComponentMetaParameters struct {
...
type HyperflexDistributableDistributableMetasObservation struct {
}

type HyperflexDistributableDistributableMetasParameters struct {
...
type HyperflexDistributableNrSourceObservation struct {
}

type HyperflexDistributableNrSourceParameters struct {
...
type HyperflexDistributableObservation struct {
}

type HyperflexDistributableParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []HyperflexDistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []HyperflexDistributableCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []HyperflexDistributableComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []HyperflexDistributableDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []HyperflexDistributableNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []HyperflexDistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []HyperflexDistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []HyperflexDistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []HyperflexDistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []HyperflexDistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type HyperflexDistributableParentObservation struct {
}

type HyperflexDistributableParentParameters struct {
...
type HyperflexDistributablePermissionResourcesObservation struct {
}

type HyperflexDistributablePermissionResourcesParameters struct {
...
type HyperflexDistributableReleaseObservation struct {
}

type HyperflexDistributableReleaseParameters struct {
...
type HyperflexDistributableTagsObservation struct {
}

type HyperflexDistributableTagsParameters struct {
...
type HyperflexDistributableVersionContextInterestedMosObservation struct {
}

type HyperflexDistributableVersionContextInterestedMosParameters struct {
...
type HyperflexDistributableVersionContextObservation struct {
}

type HyperflexDistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []HyperflexDistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []HyperflexDistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type HyperflexDistributableVersionContextRefMoObservation struct {
}

type HyperflexDistributableVersionContextRefMoParameters struct {
...
// HyperflexDistributableSpec defines the desired state of HyperflexDistributable
type HyperflexDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     HyperflexDistributableParameters `json:"forProvider"`
}

// HyperflexDistributableStatus defines the observed state of HyperflexDistributable.
type HyperflexDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        HyperflexDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// HyperflexDistributable is the Schema for the HyperflexDistributables API
...
type HyperflexDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              HyperflexDistributableSpec   `json:"spec"`
	Status            HyperflexDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// HyperflexDistributableList contains a list of HyperflexDistributables
type HyperflexDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []HyperflexDistributable `json:"items"`
}

// Repository type metadata.
var (
	HyperflexDistributable_Kind             = "HyperflexDistributable"
	HyperflexDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: HyperflexDistributable_Kind}.String()
	HyperflexDistributable_KindAPIVersion   = HyperflexDistributable_Kind + "." + CRDGroupVersion.String()
	HyperflexDistributable_GroupVersionKind = CRDGroupVersion.WithKind(HyperflexDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&HyperflexDistributable{}, &HyperflexDistributableList{})
}
