...
type HyperflexBundleDistributableAncestorsObservation struct {
}

type HyperflexBundleDistributableAncestorsParameters struct {
...
type HyperflexBundleDistributableCatalogObservation struct {
}

type HyperflexBundleDistributableCatalogParameters struct {
...
type HyperflexBundleDistributableComponentMetaObservation struct {
}

type HyperflexBundleDistributableComponentMetaParameters struct {
...
type HyperflexBundleDistributableDistributableMetasObservation struct {
}

type HyperflexBundleDistributableDistributableMetasParameters struct {
...
type HyperflexBundleDistributableNrSourceObservation struct {
}

type HyperflexBundleDistributableNrSourceParameters struct {
...
type HyperflexBundleDistributableObservation struct {
}

type HyperflexBundleDistributableParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []HyperflexBundleDistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []HyperflexBundleDistributableCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []HyperflexBundleDistributableComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []HyperflexBundleDistributableDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []HyperflexBundleDistributableNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []HyperflexBundleDistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []HyperflexBundleDistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []HyperflexBundleDistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []HyperflexBundleDistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []HyperflexBundleDistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type HyperflexBundleDistributableParentObservation struct {
}

type HyperflexBundleDistributableParentParameters struct {
...
type HyperflexBundleDistributablePermissionResourcesObservation struct {
}

type HyperflexBundleDistributablePermissionResourcesParameters struct {
...
type HyperflexBundleDistributableReleaseObservation struct {
}

type HyperflexBundleDistributableReleaseParameters struct {
...
type HyperflexBundleDistributableTagsObservation struct {
}

type HyperflexBundleDistributableTagsParameters struct {
...
type HyperflexBundleDistributableVersionContextInterestedMosObservation struct {
}

type HyperflexBundleDistributableVersionContextInterestedMosParameters struct {
...
type HyperflexBundleDistributableVersionContextObservation struct {
}

type HyperflexBundleDistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []HyperflexBundleDistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []HyperflexBundleDistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type HyperflexBundleDistributableVersionContextRefMoObservation struct {
}

type HyperflexBundleDistributableVersionContextRefMoParameters struct {
...
// HyperflexBundleDistributableSpec defines the desired state of HyperflexBundleDistributable
type HyperflexBundleDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     HyperflexBundleDistributableParameters `json:"forProvider"`
}

// HyperflexBundleDistributableStatus defines the observed state of HyperflexBundleDistributable.
type HyperflexBundleDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        HyperflexBundleDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// HyperflexBundleDistributable is the Schema for the HyperflexBundleDistributables API
...
type HyperflexBundleDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              HyperflexBundleDistributableSpec   `json:"spec"`
	Status            HyperflexBundleDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// HyperflexBundleDistributableList contains a list of HyperflexBundleDistributables
type HyperflexBundleDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []HyperflexBundleDistributable `json:"items"`
}

// Repository type metadata.
var (
	HyperflexBundleDistributable_Kind             = "HyperflexBundleDistributable"
	HyperflexBundleDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: HyperflexBundleDistributable_Kind}.String()
	HyperflexBundleDistributable_KindAPIVersion   = HyperflexBundleDistributable_Kind + "." + CRDGroupVersion.String()
	HyperflexBundleDistributable_GroupVersionKind = CRDGroupVersion.WithKind(HyperflexBundleDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&HyperflexBundleDistributable{}, &HyperflexBundleDistributableList{})
}
