...
type UcsdBundleDistributableAncestorsObservation struct {
}

type UcsdBundleDistributableAncestorsParameters struct {
...
type UcsdBundleDistributableCatalogObservation struct {
}

type UcsdBundleDistributableCatalogParameters struct {
...
type UcsdBundleDistributableComponentMetaObservation struct {
}

type UcsdBundleDistributableComponentMetaParameters struct {
...
type UcsdBundleDistributableDistributableMetasObservation struct {
}

type UcsdBundleDistributableDistributableMetasParameters struct {
...
type UcsdBundleDistributableImagesObservation struct {
}

type UcsdBundleDistributableImagesParameters struct {
...
type UcsdBundleDistributableNrSourceObservation struct {
}

type UcsdBundleDistributableNrSourceParameters struct {
...
type UcsdBundleDistributableObservation struct {
}

type UcsdBundleDistributableParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []UcsdBundleDistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []UcsdBundleDistributableCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []UcsdBundleDistributableComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []UcsdBundleDistributableDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Images []UcsdBundleDistributableImagesParameters `json:"images,omitempty" tf:"images,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []UcsdBundleDistributableNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []UcsdBundleDistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []UcsdBundleDistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []UcsdBundleDistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []UcsdBundleDistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []UcsdBundleDistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type UcsdBundleDistributableParentObservation struct {
}

type UcsdBundleDistributableParentParameters struct {
...
type UcsdBundleDistributablePermissionResourcesObservation struct {
}

type UcsdBundleDistributablePermissionResourcesParameters struct {
...
type UcsdBundleDistributableReleaseObservation struct {
}

type UcsdBundleDistributableReleaseParameters struct {
...
type UcsdBundleDistributableTagsObservation struct {
}

type UcsdBundleDistributableTagsParameters struct {
...
type UcsdBundleDistributableVersionContextInterestedMosObservation struct {
}

type UcsdBundleDistributableVersionContextInterestedMosParameters struct {
...
type UcsdBundleDistributableVersionContextObservation struct {
}

type UcsdBundleDistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []UcsdBundleDistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []UcsdBundleDistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type UcsdBundleDistributableVersionContextRefMoObservation struct {
}

type UcsdBundleDistributableVersionContextRefMoParameters struct {
...
// UcsdBundleDistributableSpec defines the desired state of UcsdBundleDistributable
type UcsdBundleDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     UcsdBundleDistributableParameters `json:"forProvider"`
}

// UcsdBundleDistributableStatus defines the observed state of UcsdBundleDistributable.
type UcsdBundleDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        UcsdBundleDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// UcsdBundleDistributable is the Schema for the UcsdBundleDistributables API
...
type UcsdBundleDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              UcsdBundleDistributableSpec   `json:"spec"`
	Status            UcsdBundleDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// UcsdBundleDistributableList contains a list of UcsdBundleDistributables
type UcsdBundleDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []UcsdBundleDistributable `json:"items"`
}

// Repository type metadata.
var (
	UcsdBundleDistributable_Kind             = "UcsdBundleDistributable"
	UcsdBundleDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: UcsdBundleDistributable_Kind}.String()
	UcsdBundleDistributable_KindAPIVersion   = UcsdBundleDistributable_Kind + "." + CRDGroupVersion.String()
	UcsdBundleDistributable_GroupVersionKind = CRDGroupVersion.WithKind(UcsdBundleDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&UcsdBundleDistributable{}, &UcsdBundleDistributableList{})
}
