...
type UcsdDistributableAncestorsObservation struct {
}

type UcsdDistributableAncestorsParameters struct {
...
type UcsdDistributableCatalogObservation struct {
}

type UcsdDistributableCatalogParameters struct {
...
type UcsdDistributableComponentMetaObservation struct {
}

type UcsdDistributableComponentMetaParameters struct {
...
type UcsdDistributableDistributableMetasObservation struct {
}

type UcsdDistributableDistributableMetasParameters struct {
...
type UcsdDistributableNrSourceObservation struct {
}

type UcsdDistributableNrSourceParameters struct {
...
type UcsdDistributableObservation struct {
}

type UcsdDistributableParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []UcsdDistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []UcsdDistributableCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []UcsdDistributableComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []UcsdDistributableDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []UcsdDistributableNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []UcsdDistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []UcsdDistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []UcsdDistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []UcsdDistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []UcsdDistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type UcsdDistributableParentObservation struct {
}

type UcsdDistributableParentParameters struct {
...
type UcsdDistributablePermissionResourcesObservation struct {
}

type UcsdDistributablePermissionResourcesParameters struct {
...
type UcsdDistributableReleaseObservation struct {
}

type UcsdDistributableReleaseParameters struct {
...
type UcsdDistributableTagsObservation struct {
}

type UcsdDistributableTagsParameters struct {
...
type UcsdDistributableVersionContextInterestedMosObservation struct {
}

type UcsdDistributableVersionContextInterestedMosParameters struct {
...
type UcsdDistributableVersionContextObservation struct {
}

type UcsdDistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []UcsdDistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []UcsdDistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type UcsdDistributableVersionContextRefMoObservation struct {
}

type UcsdDistributableVersionContextRefMoParameters struct {
...
// UcsdDistributableSpec defines the desired state of UcsdDistributable
type UcsdDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     UcsdDistributableParameters `json:"forProvider"`
}

// UcsdDistributableStatus defines the observed state of UcsdDistributable.
type UcsdDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        UcsdDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// UcsdDistributable is the Schema for the UcsdDistributables API
...
type UcsdDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              UcsdDistributableSpec   `json:"spec"`
	Status            UcsdDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// UcsdDistributableList contains a list of UcsdDistributables
type UcsdDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []UcsdDistributable `json:"items"`
}

// Repository type metadata.
var (
	UcsdDistributable_Kind             = "UcsdDistributable"
	UcsdDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: UcsdDistributable_Kind}.String()
	UcsdDistributable_KindAPIVersion   = UcsdDistributable_Kind + "." + CRDGroupVersion.String()
	UcsdDistributable_GroupVersionKind = CRDGroupVersion.WithKind(UcsdDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&UcsdDistributable{}, &UcsdDistributableList{})
}
