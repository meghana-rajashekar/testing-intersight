...
type HclMetaAncestorsObservation struct {
}

type HclMetaAncestorsParameters struct {
...
type HclMetaCatalogObservation struct {
}

type HclMetaCatalogParameters struct {
...
type HclMetaComponentMetaObservation struct {
}

type HclMetaComponentMetaParameters struct {
...
type HclMetaDistributableMetasObservation struct {
}

type HclMetaDistributableMetasParameters struct {
...
type HclMetaNrSourceObservation struct {
}

type HclMetaNrSourceParameters struct {
...
type HclMetaObservation struct {
}

type HclMetaParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []HclMetaAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []HclMetaCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []HclMetaComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []HclMetaDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []HclMetaNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []HclMetaParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []HclMetaPermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []HclMetaReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []HclMetaTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []HclMetaVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type HclMetaParentObservation struct {
}

type HclMetaParentParameters struct {
...
type HclMetaPermissionResourcesObservation struct {
}

type HclMetaPermissionResourcesParameters struct {
...
type HclMetaReleaseObservation struct {
}

type HclMetaReleaseParameters struct {
...
type HclMetaTagsObservation struct {
}

type HclMetaTagsParameters struct {
...
type HclMetaVersionContextObservation struct {
}

type HclMetaVersionContextParameters struct {
...
// HclMetaSpec defines the desired state of HclMeta
type HclMetaSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     HclMetaParameters `json:"forProvider"`
}

// HclMetaStatus defines the observed state of HclMeta.
type HclMetaStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        HclMetaObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// HclMeta is the Schema for the HclMetas API
...
type HclMeta struct {
	...
	Spec              HclMetaSpec   `json:"spec"`
	Status            HclMetaStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// HclMetaList contains a list of HclMetas
type HclMetaList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []HclMeta `json:"items"`
}

// Repository type metadata.
var (
	HclMeta_Kind             = "HclMeta"
	HclMeta_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: HclMeta_Kind}.String()
	HclMeta_KindAPIVersion   = HclMeta_Kind + "." + CRDGroupVersion.String()
	HclMeta_GroupVersionKind = CRDGroupVersion.WithKind(HclMeta_Kind)
)

func init() {
	SchemeBuilder.Register(&HclMeta{}, &HclMetaList{})
}
