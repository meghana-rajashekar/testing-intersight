...
type ConnectorPackUpgradeObservation struct {
}

type ConnectorPackUpgradeParameters struct {
	...
	// +kubebuilder:validation:Optional
	ConnectorPackOpType *string `json:"connectorPackOpType,omitempty" tf:"connector_pack_op_type,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	UcsdInfo []UcsdInfoParameters `json:"ucsdInfo,omitempty" tf:"ucsd_info,omitempty"`
...
type UcsdInfoObservation struct {
}

type UcsdInfoParameters struct {
...
// ConnectorPackUpgradeSpec defines the desired state of ConnectorPackUpgrade
type ConnectorPackUpgradeSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ConnectorPackUpgradeParameters `json:"forProvider"`
}

// ConnectorPackUpgradeStatus defines the observed state of ConnectorPackUpgrade.
type ConnectorPackUpgradeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ConnectorPackUpgradeObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// ConnectorPackUpgrade is the Schema for the ConnectorPackUpgrades API
...
type ConnectorPackUpgrade struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              ConnectorPackUpgradeSpec   `json:"spec"`
	Status            ConnectorPackUpgradeStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ConnectorPackUpgradeList contains a list of ConnectorPackUpgrades
type ConnectorPackUpgradeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ConnectorPackUpgrade `json:"items"`
}

// Repository type metadata.
var (
	ConnectorPackUpgrade_Kind             = "ConnectorPackUpgrade"
	ConnectorPackUpgrade_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ConnectorPackUpgrade_Kind}.String()
	ConnectorPackUpgrade_KindAPIVersion   = ConnectorPackUpgrade_Kind + "." + CRDGroupVersion.String()
	ConnectorPackUpgrade_GroupVersionKind = CRDGroupVersion.WithKind(ConnectorPackUpgrade_Kind)
)

func init() {
	SchemeBuilder.Register(&ConnectorPackUpgrade{}, &ConnectorPackUpgradeList{})
}
