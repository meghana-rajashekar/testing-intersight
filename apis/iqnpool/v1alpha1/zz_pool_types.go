...
type IqnSuffixBlocksObservation struct {
}

type IqnSuffixBlocksParameters struct {
...
type PoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	IqnSuffixBlocks []IqnSuffixBlocksParameters `json:"iqnSuffixBlocks,omitempty" tf:"iqn_suffix_blocks,omitempty"`
