...
type ChassisProfileObservation struct {
}

type ChassisProfileParameters struct {
...
type ConfigImportObservation struct {
}

type ConfigImportParameters struct {
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	ChassisProfile []ChassisProfileParameters `json:"chassisProfile,omitempty" tf:"chassis_profile,omitempty"`
	...
	// +kubebuilder:validation:Optional
	PolicyTypes []*string `json:"policyTypes,omitempty" tf:"policy_types,omitempty"`
...
// ConfigImportSpec defines the desired state of ConfigImport
type ConfigImportSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ConfigImportParameters `json:"forProvider"`
}

// ConfigImportStatus defines the observed state of ConfigImport.
type ConfigImportStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ConfigImportObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// ConfigImport is the Schema for the ConfigImports API
...
type ConfigImport struct {
	...
	Spec              ConfigImportSpec   `json:"spec"`
	Status            ConfigImportStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ConfigImportList contains a list of ConfigImports
type ConfigImportList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ConfigImport `json:"items"`
}

// Repository type metadata.
var (
	ConfigImport_Kind             = "ConfigImport"
	ConfigImport_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ConfigImport_Kind}.String()
	ConfigImport_KindAPIVersion   = ConfigImport_Kind + "." + CRDGroupVersion.String()
	ConfigImport_GroupVersionKind = CRDGroupVersion.WithKind(ConfigImport_Kind)
)

func init() {
	SchemeBuilder.Register(&ConfigImport{}, &ConfigImportList{})
}
