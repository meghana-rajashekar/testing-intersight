...
type AssignedChassisObservation struct {
}

type AssignedChassisParameters struct {
...
type AssociatedChassisObservation struct {
}

type AssociatedChassisParameters struct {
...
type IomProfilesObservation struct {
}

type IomProfilesParameters struct {
...
type ProfileParameters struct {
	...
	// +kubebuilder:validation:Optional
	AssignedChassis []AssignedChassisParameters `json:"assignedChassis,omitempty" tf:"assigned_chassis,omitempty"`

	// A reference to a equipmentChassis resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	AssociatedChassis []AssociatedChassisParameters `json:"associatedChassis,omitempty" tf:"associated_chassis,omitempty"`
	...
	// +kubebuilder:validation:Optional
	IomProfiles []IomProfilesParameters `json:"iomProfiles,omitempty" tf:"iom_profiles,omitempty"`
