...
type ProfileParameters struct {
	...
	// +kubebuilder:validation:Optional
	RouterNodes []RouterNodesParameters `json:"routerNodes,omitempty" tf:"router_nodes,omitempty"`

	// A reference to a sdwanRouterPolicy resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	RouterPolicy []RouterPolicyParameters `json:"routerPolicy,omitempty" tf:"router_policy,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	VmanageAccount []VmanageAccountParameters `json:"vmanageAccount,omitempty" tf:"vmanage_account,omitempty"`
}
...
type RouterNodesObservation struct {
}

type RouterNodesParameters struct {
...
type RouterPolicyObservation struct {
}

type RouterPolicyParameters struct {
...
type VmanageAccountObservation struct {
}

type VmanageAccountParameters struct {
