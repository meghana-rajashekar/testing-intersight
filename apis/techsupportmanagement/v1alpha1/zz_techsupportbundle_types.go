...
type PlatformParamObservation struct {
}

type PlatformParamParameters struct {
...
type TechSupportBundleAncestorsObservation struct {
}

type TechSupportBundleAncestorsParameters struct {
...
type TechSupportBundleObservation struct {
}

type TechSupportBundleParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []TechSupportBundleAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DeviceIdentifier *string `json:"deviceIdentifier,omitempty" tf:"device_identifier,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []TechSupportBundleParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []TechSupportBundlePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// +kubebuilder:validation:Optional
	PlatformParam []PlatformParamParameters `json:"platformParam,omitempty" tf:"platform_param,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []TechSupportBundleTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	TechSupportStatus []TechSupportStatusParameters `json:"techSupportStatus,omitempty" tf:"tech_support_status,omitempty"`

	// The versioning info for this managed object.
	// +kubebuilder:validation:Optional
	VersionContext []TechSupportBundleVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type TechSupportBundleParentObservation struct {
}

type TechSupportBundleParentParameters struct {
...
type TechSupportBundlePermissionResourcesObservation struct {
}

type TechSupportBundlePermissionResourcesParameters struct {
...
type TechSupportBundleTagsObservation struct {
}

type TechSupportBundleTagsParameters struct {
...
type TechSupportBundleVersionContextObservation struct {
}

type TechSupportBundleVersionContextParameters struct {
...
type TechSupportStatusObservation struct {
}

type TechSupportStatusParameters struct {
...
// TechSupportBundleSpec defines the desired state of TechSupportBundle
type TechSupportBundleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     TechSupportBundleParameters `json:"forProvider"`
}

// TechSupportBundleStatus defines the observed state of TechSupportBundle.
type TechSupportBundleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        TechSupportBundleObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// TechSupportBundle is the Schema for the TechSupportBundles API
...
type TechSupportBundle struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              TechSupportBundleSpec   `json:"spec"`
	Status            TechSupportBundleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// TechSupportBundleList contains a list of TechSupportBundles
type TechSupportBundleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []TechSupportBundle `json:"items"`
}

// Repository type metadata.
var (
	TechSupportBundle_Kind             = "TechSupportBundle"
	TechSupportBundle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: TechSupportBundle_Kind}.String()
	TechSupportBundle_KindAPIVersion   = TechSupportBundle_Kind + "." + CRDGroupVersion.String()
	TechSupportBundle_GroupVersionKind = CRDGroupVersion.WithKind(TechSupportBundle_Kind)
)

func init() {
	SchemeBuilder.Register(&TechSupportBundle{}, &TechSupportBundleList{})
}
