...
type CollectionControlPolicyObservation struct {
}

type CollectionControlPolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	TechSupportCollection *string `json:"techSupportCollection,omitempty" tf:"tech_support_collection,omitempty"`
...
// CollectionControlPolicySpec defines the desired state of CollectionControlPolicy
type CollectionControlPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CollectionControlPolicyParameters `json:"forProvider"`
}

// CollectionControlPolicyStatus defines the observed state of CollectionControlPolicy.
type CollectionControlPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CollectionControlPolicyObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// CollectionControlPolicy is the Schema for the CollectionControlPolicys API
...
type CollectionControlPolicy struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              CollectionControlPolicySpec   `json:"spec"`
	Status            CollectionControlPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CollectionControlPolicyList contains a list of CollectionControlPolicys
type CollectionControlPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CollectionControlPolicy `json:"items"`
}

// Repository type metadata.
var (
	CollectionControlPolicy_Kind             = "CollectionControlPolicy"
	CollectionControlPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CollectionControlPolicy_Kind}.String()
	CollectionControlPolicy_KindAPIVersion   = CollectionControlPolicy_Kind + "." + CRDGroupVersion.String()
	CollectionControlPolicy_GroupVersionKind = CRDGroupVersion.WithKind(CollectionControlPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&CollectionControlPolicy{}, &CollectionControlPolicyList{})
}
