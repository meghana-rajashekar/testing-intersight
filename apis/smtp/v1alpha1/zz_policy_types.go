...
type PolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	SMTPPort *int64 `json:"smtpPort,omitempty" tf:"smtp_port,omitempty"`

	// +kubebuilder:validation:Optional
	SMTPRecipients []*string `json:"smtpRecipients,omitempty" tf:"smtp_recipients,omitempty"`
	...
	// +kubebuilder:validation:Optional
	SenderEmail *string `json:"senderEmail,omitempty" tf:"sender_email,omitempty"`
