...
func (mg *ClusterProfile) GetTerraformResourceType() string {
	return "intersight_kubernetes_cluster_profile"
}
...
func (tr *ClusterProfile) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterProfile) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterProfile) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterProfile) SetParameters(params map[string]interface{}) error {
