...
func (mg *NetworkPolicy) GetTerraformResourceType() string {
	return "intersight_kubernetes_network_policy"
}
...
func (tr *NetworkPolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *NetworkPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *NetworkPolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *NetworkPolicy) SetParameters(params map[string]interface{}) error {
