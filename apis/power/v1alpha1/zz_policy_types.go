...
type PolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	AllocatedBudget *int64 `json:"allocatedBudget,omitempty" tf:"allocated_budget,omitempty"`
	...
	// +kubebuilder:validation:Optional
	PowerProfiling *string `json:"powerProfiling,omitempty" tf:"power_profiling,omitempty"`
	...
	// +kubebuilder:validation:Optional
	PowerRestoreState *string `json:"powerRestoreState,omitempty" tf:"power_restore_state,omitempty"`
