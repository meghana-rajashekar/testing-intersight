...
type DeploymentParameters struct {
	...
	// +kubebuilder:validation:Optional
	AvailableReplicas *int64 `json:"availableReplicas,omitempty" tf:"available_replicas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DesiredReplicas *int64 `json:"desiredReplicas,omitempty" tf:"desired_replicas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	UnavailableReplicas *int64 `json:"unavailableReplicas,omitempty" tf:"unavailable_replicas,omitempty"`
