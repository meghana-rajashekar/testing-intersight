...
type AdvisoryCountObservation struct {
}

type AdvisoryCountParameters struct {
	...
	// +kubebuilder:validation:Optional
	AdvisoryCount *int64 `json:"advisoryCount,omitempty" tf:"advisory_count,omitempty"`
...
// AdvisoryCountSpec defines the desired state of AdvisoryCount
type AdvisoryCountSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AdvisoryCountParameters `json:"forProvider"`
}

// AdvisoryCountStatus defines the observed state of AdvisoryCount.
type AdvisoryCountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AdvisoryCountObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// AdvisoryCount is the Schema for the AdvisoryCounts API
...
type AdvisoryCount struct {
	...
	Spec              AdvisoryCountSpec   `json:"spec"`
	Status            AdvisoryCountStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AdvisoryCountList contains a list of AdvisoryCounts
type AdvisoryCountList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AdvisoryCount `json:"items"`
}

// Repository type metadata.
var (
	AdvisoryCount_Kind             = "AdvisoryCount"
	AdvisoryCount_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AdvisoryCount_Kind}.String()
	AdvisoryCount_KindAPIVersion   = AdvisoryCount_Kind + "." + CRDGroupVersion.String()
	AdvisoryCount_GroupVersionKind = CRDGroupVersion.WithKind(AdvisoryCount_Kind)
)

func init() {
	SchemeBuilder.Register(&AdvisoryCount{}, &AdvisoryCountList{})
}
