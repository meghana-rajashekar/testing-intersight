...
type AddressTypeObservation struct {
}

type AddressTypeParameters struct {
	...
	// +kubebuilder:validation:Optional
	EnableIPV4 *bool `json:"enableIpV4,omitempty" tf:"enable_ip_v4,omitempty"`

	// This flag enables the use of IPv6 address for end-point access.
	// +kubebuilder:validation:Optional
	EnableIPV6 *bool `json:"enableIpV6,omitempty" tf:"enable_ip_v6,omitempty"`
...
type InbandIPPoolObservation struct {
}

type InbandIPPoolParameters struct {
...
type InbandVrfObservation struct {
}

type InbandVrfParameters struct {
...
type PolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	AddressType []AddressTypeParameters `json:"addressType,omitempty" tf:"address_type,omitempty"`
	...
	// +kubebuilder:validation:Optional
	InbandIPPool []InbandIPPoolParameters `json:"inbandIpPool,omitempty" tf:"inband_ip_pool,omitempty"`

	// VLAN to be used for server access over Inband network.
	// +kubebuilder:validation:Optional
	InbandVlan *int64 `json:"inbandVlan,omitempty" tf:"inband_vlan,omitempty"`

	// A reference to a vrfVrf resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	InbandVrf []InbandVrfParameters `json:"inbandVrf,omitempty" tf:"inband_vrf,omitempty"`
