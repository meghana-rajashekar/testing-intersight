...
type PolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	EnableLocalServerVideo *bool `json:"enableLocalServerVideo,omitempty" tf:"enable_local_server_video,omitempty"`
	...
	// +kubebuilder:validation:Optional
	EnableVideoEncryption *bool `json:"enableVideoEncryption,omitempty" tf:"enable_video_encryption,omitempty"`
	...
	// +kubebuilder:validation:Optional
	MaximumSessions *int64 `json:"maximumSessions,omitempty" tf:"maximum_sessions,omitempty"`
