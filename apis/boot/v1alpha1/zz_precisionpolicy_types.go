...
type BootDevicesObservation struct {
}

type BootDevicesParameters struct {
...
type PrecisionPolicyObservation struct {
}

type PrecisionPolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	BootDevices []BootDevicesParameters `json:"bootDevices,omitempty" tf:"boot_devices,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ConfiguredBootMode *string `json:"configuredBootMode,omitempty" tf:"configured_boot_mode,omitempty"`
	...
	// +kubebuilder:validation:Optional
	EnforceUefiSecureBoot *bool `json:"enforceUefiSecureBoot,omitempty" tf:"enforce_uefi_secure_boot,omitempty"`
...
// PrecisionPolicySpec defines the desired state of PrecisionPolicy
type PrecisionPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     PrecisionPolicyParameters `json:"forProvider"`
}

// PrecisionPolicyStatus defines the observed state of PrecisionPolicy.
type PrecisionPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PrecisionPolicyObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// PrecisionPolicy is the Schema for the PrecisionPolicys API
...
type PrecisionPolicy struct {
	...
	Spec              PrecisionPolicySpec   `json:"spec"`
	Status            PrecisionPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PrecisionPolicyList contains a list of PrecisionPolicys
type PrecisionPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PrecisionPolicy `json:"items"`
}

// Repository type metadata.
var (
	PrecisionPolicy_Kind             = "PrecisionPolicy"
	PrecisionPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PrecisionPolicy_Kind}.String()
	PrecisionPolicy_KindAPIVersion   = PrecisionPolicy_Kind + "." + CRDGroupVersion.String()
	PrecisionPolicy_GroupVersionKind = CRDGroupVersion.WithKind(PrecisionPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&PrecisionPolicy{}, &PrecisionPolicyList{})
}
