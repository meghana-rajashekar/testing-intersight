...
type AccountLicenseDataObservation struct {
}

type AccountLicenseDataParameters struct {
...
type IksLicenseCountObservation struct {
}

type IksLicenseCountParameters struct {

	// A reference to a licenseAccountLicenseData resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	AccountLicenseData []AccountLicenseDataParameters `json:"accountLicenseData,omitempty" tf:"account_license_data,omitempty"`
	...
	// +kubebuilder:validation:Optional
	AdvantageCount *int64 `json:"advantageCount,omitempty" tf:"advantage_count,omitempty"`
...
// IksLicenseCountSpec defines the desired state of IksLicenseCount
type IksLicenseCountSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     IksLicenseCountParameters `json:"forProvider"`
}

// IksLicenseCountStatus defines the observed state of IksLicenseCount.
type IksLicenseCountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        IksLicenseCountObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// IksLicenseCount is the Schema for the IksLicenseCounts API
...
type IksLicenseCount struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              IksLicenseCountSpec   `json:"spec"`
	Status            IksLicenseCountStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// IksLicenseCountList contains a list of IksLicenseCounts
type IksLicenseCountList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []IksLicenseCount `json:"items"`
}

// Repository type metadata.
var (
	IksLicenseCount_Kind             = "IksLicenseCount"
	IksLicenseCount_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IksLicenseCount_Kind}.String()
	IksLicenseCount_KindAPIVersion   = IksLicenseCount_Kind + "." + CRDGroupVersion.String()
	IksLicenseCount_GroupVersionKind = CRDGroupVersion.WithKind(IksLicenseCount_Kind)
)

func init() {
	SchemeBuilder.Register(&IksLicenseCount{}, &IksLicenseCountList{})
}
