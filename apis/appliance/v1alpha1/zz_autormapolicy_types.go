...
type AutoRmaPolicyObservation struct {
}

type AutoRmaPolicyParameters struct {
...
// AutoRmaPolicySpec defines the desired state of AutoRmaPolicy
type AutoRmaPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AutoRmaPolicyParameters `json:"forProvider"`
}

// AutoRmaPolicyStatus defines the observed state of AutoRmaPolicy.
type AutoRmaPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AutoRmaPolicyObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// AutoRmaPolicy is the Schema for the AutoRmaPolicys API
...
type AutoRmaPolicy struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              AutoRmaPolicySpec   `json:"spec"`
	Status            AutoRmaPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AutoRmaPolicyList contains a list of AutoRmaPolicys
type AutoRmaPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AutoRmaPolicy `json:"items"`
}

// Repository type metadata.
var (
	AutoRmaPolicy_Kind             = "AutoRmaPolicy"
	AutoRmaPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AutoRmaPolicy_Kind}.String()
	AutoRmaPolicy_KindAPIVersion   = AutoRmaPolicy_Kind + "." + CRDGroupVersion.String()
	AutoRmaPolicy_GroupVersionKind = CRDGroupVersion.WithKind(AutoRmaPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&AutoRmaPolicy{}, &AutoRmaPolicyList{})
}
