...
type DeviceClaimAccountObservation struct {
}

type DeviceClaimAccountParameters struct {
...
type DeviceClaimAncestorsObservation struct {
}

type DeviceClaimAncestorsParameters struct {
...
type DeviceClaimObservation struct {
}

type DeviceClaimParameters struct {

	// A reference to a iamAccount resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Account []DeviceClaimAccountParameters `json:"account,omitempty" tf:"account,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Ancestors []DeviceClaimAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	IsRenew *bool `json:"isRenew,omitempty" tf:"is_renew,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []DeviceClaimParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`
	...
	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []DeviceClaimPermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Reservation []ReservationParameters `json:"reservation,omitempty" tf:"reservation,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []DeviceClaimTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []DeviceClaimVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type DeviceClaimParentObservation struct {
}

type DeviceClaimParentParameters struct {
...
type DeviceClaimPermissionResourcesObservation struct {
}

type DeviceClaimPermissionResourcesParameters struct {
...
type DeviceClaimTagsObservation struct {
}

type DeviceClaimTagsParameters struct {
...
type DeviceClaimVersionContextInterestedMosObservation struct {
}

type DeviceClaimVersionContextInterestedMosParameters struct {
...
type DeviceClaimVersionContextObservation struct {
}

type DeviceClaimVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []DeviceClaimVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []DeviceClaimVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type DeviceClaimVersionContextRefMoObservation struct {
}

type DeviceClaimVersionContextRefMoParameters struct {
...
type DeviceClaimSpec struct {
	...
	ForProvider     DeviceClaimParameters `json:"forProvider"`
}

// DeviceClaimStatus defines the observed state of DeviceClaim.
type DeviceClaimStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DeviceClaimObservation `json:"atProvider,omitempty"`
}
...
// DeviceClaimList contains a list of DeviceClaims
...
var (
	DeviceClaim_Kind             = "DeviceClaim"
	DeviceClaim_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DeviceClaim_Kind}.String()
	DeviceClaim_KindAPIVersion   = DeviceClaim_Kind + "." + CRDGroupVersion.String()
	DeviceClaim_GroupVersionKind = CRDGroupVersion.WithKind(DeviceClaim_Kind)
)
