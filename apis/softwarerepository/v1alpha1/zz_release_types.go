...
type ReleaseAncestorsObservation struct {
}

type ReleaseAncestorsParameters struct {
...
type ReleaseCatalogObservation struct {
}

type ReleaseCatalogParameters struct {
...
type ReleaseParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []ReleaseAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`

	// A reference to a softwarerepositoryCatalog resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Catalog []ReleaseCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []ReleaseParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []ReleasePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []ReleaseTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []ReleaseVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type ReleaseParentObservation struct {
}

type ReleaseParentParameters struct {
...
type ReleasePermissionResourcesObservation struct {
}

type ReleasePermissionResourcesParameters struct {
...
type ReleaseTagsObservation struct {
}

type ReleaseTagsParameters struct {
...
type ReleaseVersionContextInterestedMosObservation struct {
}

type ReleaseVersionContextInterestedMosParameters struct {
...
type ReleaseVersionContextObservation struct {
}

type ReleaseVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []ReleaseVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []ReleaseVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type ReleaseVersionContextRefMoObservation struct {
}

type ReleaseVersionContextRefMoParameters struct {
