...
func (mg *Authorization) GetTerraformResourceType() string {
	return "intersight_softwarerepository_authorization"
}
...
func (tr *Authorization) GetObservation() (map[string]interface{}, error) {
...
func (tr *Authorization) SetObservation(obs map[string]interface{}) error {
...
func (tr *Authorization) GetParameters() (map[string]interface{}, error) {
...
func (tr *Authorization) SetParameters(params map[string]interface{}) error {
