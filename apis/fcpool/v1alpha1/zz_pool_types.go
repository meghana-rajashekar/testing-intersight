...
type BlockHeadsObservation struct {
}

type BlockHeadsParameters struct {
...
type IDBlocksObservation struct {
}

type IDBlocksParameters struct {
...
type PoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	BlockHeads []BlockHeadsParameters `json:"blockHeads,omitempty" tf:"block_heads,omitempty"`
	...
	// +kubebuilder:validation:Optional
	IDBlocks []IDBlocksParameters `json:"idBlocks,omitempty" tf:"id_blocks,omitempty"`
	...
	// +kubebuilder:validation:Optional
	PoolPurpose *string `json:"poolPurpose,omitempty" tf:"pool_purpose,omitempty"`
