...
type AppliancePcRoleObservation struct {
}

type AppliancePcRoleParameters struct {
	...
	// +kubebuilder:validation:Optional
	EthNetworkControlPolicy []EthNetworkControlPolicyParameters `json:"ethNetworkControlPolicy,omitempty" tf:"eth_network_control_policy,omitempty"`

	// A reference to a fabricEthNetworkGroupPolicy resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	EthNetworkGroupPolicy []EthNetworkGroupPolicyParameters `json:"ethNetworkGroupPolicy,omitempty" tf:"eth_network_group_policy,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	PortPolicy []PortPolicyParameters `json:"portPolicy,omitempty" tf:"port_policy,omitempty"`
...
type EthNetworkControlPolicyObservation struct {
}

type EthNetworkControlPolicyParameters struct {
...
type EthNetworkGroupPolicyObservation struct {
}

type EthNetworkGroupPolicyParameters struct {
...
type PortPolicyObservation struct {
}

type PortPolicyParameters struct {
...
// AppliancePcRoleSpec defines the desired state of AppliancePcRole
type AppliancePcRoleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AppliancePcRoleParameters `json:"forProvider"`
}

// AppliancePcRoleStatus defines the observed state of AppliancePcRole.
type AppliancePcRoleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AppliancePcRoleObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// AppliancePcRole is the Schema for the AppliancePcRoles API
...
type AppliancePcRole struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              AppliancePcRoleSpec   `json:"spec"`
	Status            AppliancePcRoleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AppliancePcRoleList contains a list of AppliancePcRoles
type AppliancePcRoleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AppliancePcRole `json:"items"`
}

// Repository type metadata.
var (
	AppliancePcRole_Kind             = "AppliancePcRole"
	AppliancePcRole_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AppliancePcRole_Kind}.String()
	AppliancePcRole_KindAPIVersion   = AppliancePcRole_Kind + "." + CRDGroupVersion.String()
	AppliancePcRole_GroupVersionKind = CRDGroupVersion.WithKind(AppliancePcRole_Kind)
)

func init() {
	SchemeBuilder.Register(&AppliancePcRole{}, &AppliancePcRoleList{})
}
