...
type PolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	AlternateIpv4DnsServer *string `json:"alternateIpv4DnsServer,omitempty" tf:"alternate_ipv4dns_server,omitempty"`

	// IP address of the secondary DNS server.
	// +kubebuilder:validation:Optional
	AlternateIpv6DnsServer *string `json:"alternateIpv6DnsServer,omitempty" tf:"alternate_ipv6dns_server,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DynamicDNSDomain *string `json:"dynamicDnsDomain,omitempty" tf:"dynamic_dns_domain,omitempty"`

	// If enabled, updates the resource records to the DNS from Cisco IMC.
	// +kubebuilder:validation:Optional
	EnableDynamicDNS *bool `json:"enableDynamicDns,omitempty" tf:"enable_dynamic_dns,omitempty"`
	...
	// +kubebuilder:validation:Optional
	EnableIpv4DnsFromDhcp *bool `json:"enableIpv4DnsFromDhcp,omitempty" tf:"enable_ipv4dns_from_dhcp,omitempty"`
	...
	// +kubebuilder:validation:Optional
	EnableIpv6DnsFromDhcp *bool `json:"enableIpv6DnsFromDhcp,omitempty" tf:"enable_ipv6dns_from_dhcp,omitempty"`
	...
	// +kubebuilder:validation:Optional
	PreferredIpv4DnsServer *string `json:"preferredIpv4DnsServer,omitempty" tf:"preferred_ipv4dns_server,omitempty"`

	// IP address of the primary DNS server.
	// +kubebuilder:validation:Optional
	PreferredIpv6DnsServer *string `json:"preferredIpv6DnsServer,omitempty" tf:"preferred_ipv6dns_server,omitempty"`
