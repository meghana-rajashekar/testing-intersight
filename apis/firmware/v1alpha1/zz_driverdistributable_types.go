...
type DriverDistributableAncestorsObservation struct {
}

type DriverDistributableAncestorsParameters struct {
...
type DriverDistributableCatalogObservation struct {
}

type DriverDistributableCatalogParameters struct {
...
type DriverDistributableComponentMetaObservation struct {
}

type DriverDistributableComponentMetaParameters struct {
...
type DriverDistributableDistributableMetasObservation struct {
}

type DriverDistributableDistributableMetasParameters struct {
...
type DriverDistributableNrSourceObservation struct {
}

type DriverDistributableNrSourceParameters struct {
...
type DriverDistributableObservation struct {
}

type DriverDistributableParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []DriverDistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Catalog []DriverDistributableCatalogParameters `json:"catalog,omitempty" tf:"catalog,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []DriverDistributableComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []DriverDistributableDistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NrSource []DriverDistributableNrSourceParameters `json:"nrSource,omitempty" tf:"nr_source,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Osname *string `json:"osname,omitempty" tf:"osname,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []DriverDistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []DriverDistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []DriverDistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []DriverDistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []DriverDistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type DriverDistributableParentObservation struct {
}

type DriverDistributableParentParameters struct {
...
type DriverDistributablePermissionResourcesObservation struct {
}

type DriverDistributablePermissionResourcesParameters struct {
...
type DriverDistributableReleaseObservation struct {
}

type DriverDistributableReleaseParameters struct {
...
type DriverDistributableTagsObservation struct {
}

type DriverDistributableTagsParameters struct {
...
type DriverDistributableVersionContextInterestedMosObservation struct {
}

type DriverDistributableVersionContextInterestedMosParameters struct {
...
type DriverDistributableVersionContextObservation struct {
}

type DriverDistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []DriverDistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []DriverDistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type DriverDistributableVersionContextRefMoObservation struct {
}

type DriverDistributableVersionContextRefMoParameters struct {
...
// DriverDistributableSpec defines the desired state of DriverDistributable
type DriverDistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DriverDistributableParameters `json:"forProvider"`
}

// DriverDistributableStatus defines the observed state of DriverDistributable.
type DriverDistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DriverDistributableObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// DriverDistributable is the Schema for the DriverDistributables API
...
type DriverDistributable struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              DriverDistributableSpec   `json:"spec"`
	Status            DriverDistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DriverDistributableList contains a list of DriverDistributables
type DriverDistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DriverDistributable `json:"items"`
}

// Repository type metadata.
var (
	DriverDistributable_Kind             = "DriverDistributable"
	DriverDistributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DriverDistributable_Kind}.String()
	DriverDistributable_KindAPIVersion   = DriverDistributable_Kind + "." + CRDGroupVersion.String()
	DriverDistributable_GroupVersionKind = CRDGroupVersion.WithKind(DriverDistributable_Kind)
)

func init() {
	SchemeBuilder.Register(&DriverDistributable{}, &DriverDistributableList{})
}
