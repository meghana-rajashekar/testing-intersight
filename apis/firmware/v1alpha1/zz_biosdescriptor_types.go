...
type BiosDescriptorObservation struct {
}

type BiosDescriptorParameters struct {
...
// BiosDescriptorSpec defines the desired state of BiosDescriptor
type BiosDescriptorSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     BiosDescriptorParameters `json:"forProvider"`
}

// BiosDescriptorStatus defines the observed state of BiosDescriptor.
type BiosDescriptorStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BiosDescriptorObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// BiosDescriptor is the Schema for the BiosDescriptors API
...
type BiosDescriptor struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              BiosDescriptorSpec   `json:"spec"`
	Status            BiosDescriptorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BiosDescriptorList contains a list of BiosDescriptors
type BiosDescriptorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BiosDescriptor `json:"items"`
}

// Repository type metadata.
var (
	BiosDescriptor_Kind             = "BiosDescriptor"
	BiosDescriptor_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BiosDescriptor_Kind}.String()
	BiosDescriptor_KindAPIVersion   = BiosDescriptor_Kind + "." + CRDGroupVersion.String()
	BiosDescriptor_GroupVersionKind = CRDGroupVersion.WithKind(BiosDescriptor_Kind)
)

func init() {
	SchemeBuilder.Register(&BiosDescriptor{}, &BiosDescriptorList{})
}
