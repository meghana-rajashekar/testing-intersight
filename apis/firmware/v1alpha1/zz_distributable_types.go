...
type ComponentMetaObservation struct {
}

type ComponentMetaParameters struct {
...
type DistributableAncestorsObservation struct {
}

type DistributableAncestorsParameters struct {
...
type DistributableMetasObservation struct {
}

type DistributableMetasParameters struct {
...
type DistributableObservation_2 struct {
}

type DistributableParameters_2 struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []DistributableAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ComponentMeta []ComponentMetaParameters `json:"componentMeta,omitempty" tf:"component_meta,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DistributableMetas []DistributableMetasParameters `json:"distributableMetas,omitempty" tf:"distributable_metas,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []DistributableParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []DistributablePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []DistributableReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []DistributableTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []DistributableVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type DistributableParentObservation struct {
}

type DistributableParentParameters struct {
...
type DistributablePermissionResourcesObservation struct {
}

type DistributablePermissionResourcesParameters struct {
...
type DistributableReleaseObservation struct {
}

type DistributableReleaseParameters struct {
...
type DistributableTagsObservation struct {
}

type DistributableTagsParameters struct {
...
type DistributableVersionContextInterestedMosObservation struct {
}

type DistributableVersionContextInterestedMosParameters struct {
...
type DistributableVersionContextObservation struct {
}

type DistributableVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []DistributableVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []DistributableVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type DistributableVersionContextRefMoObservation struct {
}

type DistributableVersionContextRefMoParameters struct {
...
// DistributableSpec defines the desired state of Distributable
type DistributableSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DistributableParameters_2 `json:"forProvider"`
}

// DistributableStatus defines the observed state of Distributable.
type DistributableStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DistributableObservation_2 `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// Distributable is the Schema for the Distributables API
...
type Distributable struct {
	...
	Spec              DistributableSpec   `json:"spec"`
	Status            DistributableStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DistributableList contains a list of Distributables
type DistributableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Distributable `json:"items"`
}

// Repository type metadata.
var (
	Distributable_Kind             = "Distributable"
	Distributable_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Distributable_Kind}.String()
	Distributable_KindAPIVersion   = Distributable_Kind + "." + CRDGroupVersion.String()
	Distributable_GroupVersionKind = CRDGroupVersion.WithKind(Distributable_Kind)
)

func init() {
	SchemeBuilder.Register(&Distributable{}, &DistributableList{})
}
