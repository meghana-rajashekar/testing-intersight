...
type DirectDownloadHTTPServerObservation struct {
}

type DirectDownloadHTTPServerParameters struct {
...
type NetworkElementsObservation struct {
}

type NetworkElementsParameters struct {
...
type NetworkShareCifsServerObservation struct {
}

type NetworkShareCifsServerParameters struct {
...
type NetworkShareNfsServerObservation struct {
}

type NetworkShareNfsServerParameters struct {
...
type SwitchUpgradeAncestorsObservation struct {
}

type SwitchUpgradeAncestorsParameters struct {
...
type SwitchUpgradeDeviceObservation struct {
}

type SwitchUpgradeDeviceParameters struct {
...
type SwitchUpgradeDirectDownloadObservation struct {
}

type SwitchUpgradeDirectDownloadParameters struct {
	...
	// +kubebuilder:validation:Optional
	HTTPServer []DirectDownloadHTTPServerParameters `json:"httpServer,omitempty" tf:"http_server,omitempty"`
...
type SwitchUpgradeDistributableObservation struct {
}

type SwitchUpgradeDistributableParameters struct {
...
type SwitchUpgradeFileServerObservation struct {
}

type SwitchUpgradeFileServerParameters struct {
...
type SwitchUpgradeNetworkShareHTTPServerObservation struct {
}

type SwitchUpgradeNetworkShareHTTPServerParameters struct {
...
type SwitchUpgradeNetworkShareObservation struct {
}

type SwitchUpgradeNetworkShareParameters struct {
	...
	// +kubebuilder:validation:Optional
	CifsServer []NetworkShareCifsServerParameters `json:"cifsServer,omitempty" tf:"cifs_server,omitempty"`
	...
	// +kubebuilder:validation:Optional
	HTTPServer []SwitchUpgradeNetworkShareHTTPServerParameters `json:"httpServer,omitempty" tf:"http_server,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NfsServer []NetworkShareNfsServerParameters `json:"nfsServer,omitempty" tf:"nfs_server,omitempty"`
...
type SwitchUpgradeObservation struct {
}

type SwitchUpgradeParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []SwitchUpgradeAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Device []SwitchUpgradeDeviceParameters `json:"device,omitempty" tf:"device,omitempty"`

	// Direct download options in case the upgradeType is direct download based upgrade.
	// +kubebuilder:validation:Optional
	DirectDownload []SwitchUpgradeDirectDownloadParameters `json:"directDownload,omitempty" tf:"direct_download,omitempty"`

	// A reference to a firmwareDistributable resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Distributable []SwitchUpgradeDistributableParameters `json:"distributable,omitempty" tf:"distributable,omitempty"`
	...
	// +kubebuilder:validation:Optional
	EnableFabricEvacuation *bool `json:"enableFabricEvacuation,omitempty" tf:"enable_fabric_evacuation,omitempty"`

	// Location of the image in user software repository.
	// +kubebuilder:validation:Optional
	FileServer []SwitchUpgradeFileServerParameters `json:"fileServer,omitempty" tf:"file_server,omitempty"`
	...
	// +kubebuilder:validation:Optional
	NetworkElements []NetworkElementsParameters `json:"networkElements,omitempty" tf:"network_elements,omitempty"`

	// Deprecated (Use 'fileServer' property). Network share options in case of the upgradeType is network share based upgrade.
	// +kubebuilder:validation:Optional
	NetworkShare []SwitchUpgradeNetworkShareParameters `json:"networkShare,omitempty" tf:"network_share,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []SwitchUpgradeParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []SwitchUpgradePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`

	// A reference to a softwarerepositoryRelease resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Release []SwitchUpgradeReleaseParameters `json:"release,omitempty" tf:"release,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []SwitchUpgradeTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`

	// A reference to a firmwareUpgradeImpactStatus resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	UpgradeImpact []SwitchUpgradeUpgradeImpactParameters `json:"upgradeImpact,omitempty" tf:"upgrade_impact,omitempty"`

	// A reference to a firmwareUpgradeStatus resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	UpgradeStatus []SwitchUpgradeUpgradeStatusParameters `json:"upgradeStatus,omitempty" tf:"upgrade_status,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []SwitchUpgradeVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type SwitchUpgradeParentObservation struct {
}

type SwitchUpgradeParentParameters struct {
...
type SwitchUpgradePermissionResourcesObservation struct {
}

type SwitchUpgradePermissionResourcesParameters struct {
...
type SwitchUpgradeReleaseObservation struct {
}

type SwitchUpgradeReleaseParameters struct {
...
type SwitchUpgradeTagsObservation struct {
}

type SwitchUpgradeTagsParameters struct {
...
type SwitchUpgradeUpgradeImpactObservation struct {
}

type SwitchUpgradeUpgradeImpactParameters struct {
...
type SwitchUpgradeUpgradeStatusObservation struct {
}

type SwitchUpgradeUpgradeStatusParameters struct {
...
type SwitchUpgradeVersionContextInterestedMosObservation struct {
}

type SwitchUpgradeVersionContextInterestedMosParameters struct {
...
type SwitchUpgradeVersionContextObservation struct {
}

type SwitchUpgradeVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []SwitchUpgradeVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []SwitchUpgradeVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type SwitchUpgradeVersionContextRefMoObservation struct {
}

type SwitchUpgradeVersionContextRefMoParameters struct {
...
// SwitchUpgradeSpec defines the desired state of SwitchUpgrade
type SwitchUpgradeSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SwitchUpgradeParameters `json:"forProvider"`
}

// SwitchUpgradeStatus defines the observed state of SwitchUpgrade.
type SwitchUpgradeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SwitchUpgradeObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// SwitchUpgrade is the Schema for the SwitchUpgrades API
...
type SwitchUpgrade struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SwitchUpgradeSpec   `json:"spec"`
	Status            SwitchUpgradeStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SwitchUpgradeList contains a list of SwitchUpgrades
type SwitchUpgradeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SwitchUpgrade `json:"items"`
}

// Repository type metadata.
var (
	SwitchUpgrade_Kind             = "SwitchUpgrade"
	SwitchUpgrade_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SwitchUpgrade_Kind}.String()
	SwitchUpgrade_KindAPIVersion   = SwitchUpgrade_Kind + "." + CRDGroupVersion.String()
	SwitchUpgrade_GroupVersionKind = CRDGroupVersion.WithKind(SwitchUpgrade_Kind)
)

func init() {
	SchemeBuilder.Register(&SwitchUpgrade{}, &SwitchUpgradeList{})
}
