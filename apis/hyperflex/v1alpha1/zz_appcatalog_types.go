...
type AppCatalogParameters struct {
	...
	// +kubebuilder:validation:Optional
	FeatureLimitExternal []FeatureLimitExternalParameters `json:"featureLimitExternal,omitempty" tf:"feature_limit_external,omitempty"`

	// A reference to a hyperflexFeatureLimitInternal resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	FeatureLimitInternal []FeatureLimitInternalParameters `json:"featureLimitInternal,omitempty" tf:"feature_limit_internal,omitempty"`

	// An array of relationships to hyperflexHxdpVersion resources.
	// +kubebuilder:validation:Optional
	HxdpVersions []HxdpVersionsParameters `json:"hxdpVersions,omitempty" tf:"hxdp_versions,omitempty"`

	// An array of relationships to hyperflexCapabilityInfo resources.
	// +kubebuilder:validation:Optional
	HyperflexCapabilityInfos []HyperflexCapabilityInfosParameters `json:"hyperflexCapabilityInfos,omitempty" tf:"hyperflex_capability_infos,omitempty"`

	// An array of relationships to hclHyperflexSoftwareCompatibilityInfo resources.
	// +kubebuilder:validation:Optional
	HyperflexSoftwareCompatibilityInfos []HyperflexSoftwareCompatibilityInfosParameters `json:"hyperflexSoftwareCompatibilityInfos,omitempty" tf:"hyperflex_software_compatibility_infos,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	ServerFirmwareVersion []ServerFirmwareVersionParameters `json:"serverFirmwareVersion,omitempty" tf:"server_firmware_version,omitempty"`

	// A reference to a hyperflexServerModel resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	ServerModel []ServerModelParameters `json:"serverModel,omitempty" tf:"server_model,omitempty"`
	...
	// +kubebuilder:validation:Optional
	SoftwareDistributions []SoftwareDistributionsParameters `json:"softwareDistributions,omitempty" tf:"software_distributions,omitempty"`
...
type FeatureLimitExternalObservation struct {
}

type FeatureLimitExternalParameters struct {
...
type FeatureLimitInternalObservation struct {
}

type FeatureLimitInternalParameters struct {
...
type HxdpVersionsObservation struct {
}

type HxdpVersionsParameters struct {
...
type HyperflexCapabilityInfosObservation struct {
}

type HyperflexCapabilityInfosParameters struct {
...
type HyperflexSoftwareCompatibilityInfosObservation struct {
}

type HyperflexSoftwareCompatibilityInfosParameters struct {
...
type ServerFirmwareVersionObservation struct {
}

type ServerFirmwareVersionParameters struct {
...
type ServerModelObservation struct {
}

type ServerModelParameters struct {
...
type SoftwareDistributionsObservation struct {
}

type SoftwareDistributionsParameters struct {
...
type AppCatalogSpec struct {
	...
	ForProvider     AppCatalogParameters `json:"forProvider"`
}

// AppCatalogStatus defines the observed state of AppCatalog.
type AppCatalogStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AppCatalogObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// AppCatalog is the Schema for the AppCatalogs API
...
// AppCatalogList contains a list of AppCatalogs
...
var (
	AppCatalog_Kind             = "AppCatalog"
	AppCatalog_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AppCatalog_Kind}.String()
	AppCatalog_KindAPIVersion   = AppCatalog_Kind + "." + CRDGroupVersion.String()
	AppCatalog_GroupVersionKind = CRDGroupVersion.WithKind(AppCatalog_Kind)
)

func init() {
	SchemeBuilder.Register(&AppCatalog{}, &AppCatalogList{})
}
