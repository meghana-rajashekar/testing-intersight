...
func (mg *RetentionPolicy) GetTerraformResourceType() string {
	return "intersight_aaa_retention_policy"
}
...
func (tr *RetentionPolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *RetentionPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *RetentionPolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *RetentionPolicy) SetParameters(params map[string]interface{}) error {
