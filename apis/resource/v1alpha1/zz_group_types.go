...
type GroupParameters struct {
	...
	// +kubebuilder:validation:Optional
	PerTypeCombinedSelector []PerTypeCombinedSelectorParameters `json:"perTypeCombinedSelector,omitempty" tf:"per_type_combined_selector,omitempty"`
...
type PerTypeCombinedSelectorObservation struct {
}

type PerTypeCombinedSelectorParameters struct {
	...
	// +kubebuilder:validation:Optional
	CombinedSelector *string `json:"combinedSelector,omitempty" tf:"combined_selector,omitempty"`

	// If true, then resources are added using just object type without filter.
	// +kubebuilder:validation:Optional
	EmptyFilter *bool `json:"emptyFilter,omitempty" tf:"empty_filter,omitempty"`
	...
	// +kubebuilder:validation:Optional
	SelectorObjectType *string `json:"selectorObjectType,omitempty" tf:"selector_object_type,omitempty"`
}
