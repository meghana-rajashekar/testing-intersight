...
type PoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	UUIDSuffixBlocks []UUIDSuffixBlocksParameters `json:"uuidSuffixBlocks,omitempty" tf:"uuid_suffix_blocks,omitempty"`
...
type UUIDSuffixBlocksObservation struct {
}

type UUIDSuffixBlocksParameters struct {
