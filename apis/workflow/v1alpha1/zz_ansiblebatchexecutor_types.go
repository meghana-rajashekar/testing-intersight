...
type AnsibleBatchExecutorObservation struct {
}

type AnsibleBatchExecutorParameters struct {
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	TaskDefinition []TaskDefinitionParameters `json:"taskDefinition,omitempty" tf:"task_definition,omitempty"`
...
// AnsibleBatchExecutorSpec defines the desired state of AnsibleBatchExecutor
type AnsibleBatchExecutorSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AnsibleBatchExecutorParameters `json:"forProvider"`
}

// AnsibleBatchExecutorStatus defines the observed state of AnsibleBatchExecutor.
type AnsibleBatchExecutorStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AnsibleBatchExecutorObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// AnsibleBatchExecutor is the Schema for the AnsibleBatchExecutors API
...
type AnsibleBatchExecutor struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              AnsibleBatchExecutorSpec   `json:"spec"`
	Status            AnsibleBatchExecutorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AnsibleBatchExecutorList contains a list of AnsibleBatchExecutors
type AnsibleBatchExecutorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AnsibleBatchExecutor `json:"items"`
}

// Repository type metadata.
var (
	AnsibleBatchExecutor_Kind             = "AnsibleBatchExecutor"
	AnsibleBatchExecutor_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AnsibleBatchExecutor_Kind}.String()
	AnsibleBatchExecutor_KindAPIVersion   = AnsibleBatchExecutor_Kind + "." + CRDGroupVersion.String()
	AnsibleBatchExecutor_GroupVersionKind = CRDGroupVersion.WithKind(AnsibleBatchExecutor_Kind)
)

func init() {
	SchemeBuilder.Register(&AnsibleBatchExecutor{}, &AnsibleBatchExecutorList{})
}
