...
type SshBatchExecutorAncestorsObservation struct {
}

type SshBatchExecutorAncestorsParameters struct {
...
type SshBatchExecutorBatchObservation struct {
}

type SshBatchExecutorBatchParameters struct {
...
type SshBatchExecutorConstraintsObservation struct {
}

type SshBatchExecutorConstraintsParameters struct {
...
type SshBatchExecutorObservation struct {
}

type SshBatchExecutorParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []SshBatchExecutorAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`

	// +kubebuilder:validation:Optional
	Batch []SshBatchExecutorBatchParameters `json:"batch,omitempty" tf:"batch,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Constraints []SshBatchExecutorConstraintsParameters `json:"constraints,omitempty" tf:"constraints,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Parent []SshBatchExecutorParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []SshBatchExecutorPermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []SshBatchExecutorTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`

	// A reference to a workflowTaskDefinition resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	TaskDefinition []SshBatchExecutorTaskDefinitionParameters `json:"taskDefinition,omitempty" tf:"task_definition,omitempty"`

	// The versioning info for this managed object.
	// +kubebuilder:validation:Optional
	VersionContext []SshBatchExecutorVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type SshBatchExecutorParentObservation struct {
}

type SshBatchExecutorParentParameters struct {
...
type SshBatchExecutorPermissionResourcesObservation struct {
}

type SshBatchExecutorPermissionResourcesParameters struct {
...
type SshBatchExecutorTagsObservation struct {
}

type SshBatchExecutorTagsParameters struct {
...
type SshBatchExecutorTaskDefinitionObservation struct {
}

type SshBatchExecutorTaskDefinitionParameters struct {
...
type SshBatchExecutorVersionContextInterestedMosObservation struct {
}

type SshBatchExecutorVersionContextInterestedMosParameters struct {
...
type SshBatchExecutorVersionContextObservation struct {
}

type SshBatchExecutorVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []SshBatchExecutorVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []SshBatchExecutorVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type SshBatchExecutorVersionContextRefMoObservation struct {
}

type SshBatchExecutorVersionContextRefMoParameters struct {
...
// SshBatchExecutorSpec defines the desired state of SshBatchExecutor
type SshBatchExecutorSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SshBatchExecutorParameters `json:"forProvider"`
}

// SshBatchExecutorStatus defines the observed state of SshBatchExecutor.
type SshBatchExecutorStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SshBatchExecutorObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// SshBatchExecutor is the Schema for the SshBatchExecutors API
...
type SshBatchExecutor struct {
	...
	Spec              SshBatchExecutorSpec   `json:"spec"`
	Status            SshBatchExecutorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SshBatchExecutorList contains a list of SshBatchExecutors
type SshBatchExecutorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SshBatchExecutor `json:"items"`
}

// Repository type metadata.
var (
	SshBatchExecutor_Kind             = "SshBatchExecutor"
	SshBatchExecutor_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SshBatchExecutor_Kind}.String()
	SshBatchExecutor_KindAPIVersion   = SshBatchExecutor_Kind + "." + CRDGroupVersion.String()
	SshBatchExecutor_GroupVersionKind = CRDGroupVersion.WithKind(SshBatchExecutor_Kind)
)

func init() {
	SchemeBuilder.Register(&SshBatchExecutor{}, &SshBatchExecutorList{})
}
