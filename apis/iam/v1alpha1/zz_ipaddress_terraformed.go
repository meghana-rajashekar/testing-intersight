...
func (mg *IpAddress) GetTerraformResourceType() string {
	return "intersight_iam_ip_address"
}
...
func (tr *IpAddress) GetObservation() (map[string]interface{}, error) {
...
func (tr *IpAddress) SetObservation(obs map[string]interface{}) error {
...
func (tr *IpAddress) GetParameters() (map[string]interface{}, error) {
...
func (tr *IpAddress) SetParameters(params map[string]interface{}) error {
