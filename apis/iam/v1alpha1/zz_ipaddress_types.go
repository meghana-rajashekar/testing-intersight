...
type IpAddressAncestorsObservation struct {
}

type IpAddressAncestorsParameters struct {
...
type IpAddressParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []IpAddressAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// +kubebuilder:validation:Optional
	IPAccessManagement []IPAccessManagementParameters `json:"ipAccessManagement,omitempty" tf:"ip_access_management,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []IpAddressParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []IpAddressPermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []IpAddressTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`

	// The versioning info for this managed object.
	// +kubebuilder:validation:Optional
	VersionContext []IpAddressVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type IpAddressParentObservation struct {
}

type IpAddressParentParameters struct {
...
type IpAddressPermissionResourcesObservation struct {
}

type IpAddressPermissionResourcesParameters struct {
...
type IpAddressTagsObservation struct {
}

type IpAddressTagsParameters struct {
...
type IpAddressVersionContextInterestedMosObservation struct {
}

type IpAddressVersionContextInterestedMosParameters struct {
...
type IpAddressVersionContextObservation struct {
}

type IpAddressVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []IpAddressVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []IpAddressVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type IpAddressVersionContextRefMoObservation struct {
}

type IpAddressVersionContextRefMoParameters struct {
...
// IpAddress is the Schema for the IpAddresss API
