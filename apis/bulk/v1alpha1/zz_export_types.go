...
type ExportParameters struct {
	...
	// +kubebuilder:validation:Optional
	ExportedItems []ExportedItemsParameters `json:"exportedItems,omitempty" tf:"exported_items,omitempty"`

	// +kubebuilder:validation:Optional
	ExportedObjects []ExportedObjectsParameters `json:"exportedObjects,omitempty" tf:"exported_objects,omitempty"`

	// Contains the list of import order.
	// +kubebuilder:validation:Optional
	ImportOrder *string `json:"importOrder,omitempty" tf:"import_order,omitempty"`
...
type ExportedObjectsObservation struct {
}

type ExportedObjectsParameters struct {
