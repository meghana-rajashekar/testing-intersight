...
type BackupProfileAncestorsObservation struct {
}

type BackupProfileAncestorsParameters struct {
...
type BackupProfileObservation struct {
}

type BackupProfileOrganizationObservation struct {
}

type BackupProfileOrganizationParameters struct {
...
type BackupProfileParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []BackupProfileAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	DeviceID []DeviceIDParameters `json:"deviceId,omitempty" tf:"device_id,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Organization []BackupProfileOrganizationParameters `json:"organization,omitempty" tf:"organization,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []BackupProfileParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []BackupProfilePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	ScheduleConfig []ScheduleConfigParameters `json:"scheduleConfig,omitempty" tf:"schedule_config,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []BackupProfileTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []BackupProfileVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type BackupProfileParentObservation struct {
}

type BackupProfileParentParameters struct {
...
type BackupProfilePermissionResourcesObservation struct {
}

type BackupProfilePermissionResourcesParameters struct {
...
type BackupProfileTagsObservation struct {
}

type BackupProfileTagsParameters struct {
...
type BackupProfileVersionContextObservation struct {
}

type BackupProfileVersionContextParameters struct {
...
type DeviceIDObservation struct {
}

type DeviceIDParameters struct {
...
// BackupProfileSpec defines the desired state of BackupProfile
type BackupProfileSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     BackupProfileParameters `json:"forProvider"`
}

// BackupProfileStatus defines the observed state of BackupProfile.
type BackupProfileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BackupProfileObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// BackupProfile is the Schema for the BackupProfiles API
...
type BackupProfile struct {
	...
	Spec              BackupProfileSpec   `json:"spec"`
	Status            BackupProfileStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BackupProfileList contains a list of BackupProfiles
type BackupProfileList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BackupProfile `json:"items"`
}

// Repository type metadata.
var (
	BackupProfile_Kind             = "BackupProfile"
	BackupProfile_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BackupProfile_Kind}.String()
	BackupProfile_KindAPIVersion   = BackupProfile_Kind + "." + CRDGroupVersion.String()
	BackupProfile_GroupVersionKind = CRDGroupVersion.WithKind(BackupProfile_Kind)
)

func init() {
	SchemeBuilder.Register(&BackupProfile{}, &BackupProfileList{})
}
