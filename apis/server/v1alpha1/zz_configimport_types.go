...
type ConfigImportParameters struct {
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	ServerProfile []ServerProfileParameters `json:"serverProfile,omitempty" tf:"server_profile,omitempty"`
...
type ServerProfileObservation struct {
}

type ServerProfileParameters struct {
