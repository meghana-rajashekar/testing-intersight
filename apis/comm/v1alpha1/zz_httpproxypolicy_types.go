...
// HttpProxyPolicySpec defines the desired state of HttpProxyPolicy
type HttpProxyPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     HttpProxyPolicyParameters `json:"forProvider"`
}

// HttpProxyPolicyStatus defines the observed state of HttpProxyPolicy.
type HttpProxyPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        HttpProxyPolicyObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// HttpProxyPolicy is the Schema for the HttpProxyPolicys API
...
type HttpProxyPolicy struct {
	...
	Spec              HttpProxyPolicySpec   `json:"spec"`
	Status            HttpProxyPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// HttpProxyPolicyList contains a list of HttpProxyPolicys
type HttpProxyPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []HttpProxyPolicy `json:"items"`
}

// Repository type metadata.
var (
	HttpProxyPolicy_Kind             = "HttpProxyPolicy"
	HttpProxyPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: HttpProxyPolicy_Kind}.String()
	HttpProxyPolicy_KindAPIVersion   = HttpProxyPolicy_Kind + "." + CRDGroupVersion.String()
	HttpProxyPolicy_GroupVersionKind = CRDGroupVersion.WithKind(HttpProxyPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&HttpProxyPolicy{}, &HttpProxyPolicyList{})
}
