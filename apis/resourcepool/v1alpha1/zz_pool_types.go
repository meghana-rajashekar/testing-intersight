...
type PoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	ResourcePoolParameters []ResourcePoolParametersParameters `json:"resourcePoolParameters,omitempty" tf:"resource_pool_parameters,omitempty"`
...
type ResourcePoolParametersObservation struct {
}

type ResourcePoolParametersParameters struct {
