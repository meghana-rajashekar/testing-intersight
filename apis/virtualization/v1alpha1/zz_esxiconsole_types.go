...
type EsxiConsoleAncestorsObservation struct {
}

type EsxiConsoleAncestorsParameters struct {
...
type EsxiConsoleObservation struct {
}

type EsxiConsoleParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []EsxiConsoleAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []EsxiConsoleParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []EsxiConsolePermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []EsxiConsoleTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
	...
	// +kubebuilder:validation:Optional
	VersionContext []EsxiConsoleVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`
}

type EsxiConsoleParentObservation struct {
}

type EsxiConsoleParentParameters struct {
...
type EsxiConsolePermissionResourcesObservation struct {
}

type EsxiConsolePermissionResourcesParameters struct {
...
type EsxiConsoleTagsObservation struct {
}

type EsxiConsoleTagsParameters struct {
...
type EsxiConsoleVersionContextObservation struct {
}

type EsxiConsoleVersionContextParameters struct {
...
// EsxiConsoleSpec defines the desired state of EsxiConsole
type EsxiConsoleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     EsxiConsoleParameters `json:"forProvider"`
}

// EsxiConsoleStatus defines the observed state of EsxiConsole.
type EsxiConsoleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EsxiConsoleObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// EsxiConsole is the Schema for the EsxiConsoles API
...
type EsxiConsole struct {
	...
	Spec              EsxiConsoleSpec   `json:"spec"`
	Status            EsxiConsoleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// EsxiConsoleList contains a list of EsxiConsoles
type EsxiConsoleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []EsxiConsole `json:"items"`
}

// Repository type metadata.
var (
	EsxiConsole_Kind             = "EsxiConsole"
	EsxiConsole_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EsxiConsole_Kind}.String()
	EsxiConsole_KindAPIVersion   = EsxiConsole_Kind + "." + CRDGroupVersion.String()
	EsxiConsole_GroupVersionKind = CRDGroupVersion.WithKind(EsxiConsole_Kind)
)

func init() {
	SchemeBuilder.Register(&EsxiConsole{}, &EsxiConsoleList{})
}
