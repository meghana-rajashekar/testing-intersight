...
type VirtualDiskAncestorsObservation struct {
}

type VirtualDiskAncestorsParameters struct {
...
type VirtualDiskParameters struct {
	...
	// +kubebuilder:validation:Optional
	Ancestors []VirtualDiskAncestorsParameters `json:"ancestors,omitempty" tf:"ancestors,omitempty"`

	// Billing rate for this resource.
	// +kubebuilder:validation:Optional
	BillingUnitID *string `json:"billingUnitId,omitempty" tf:"billing_unit_id,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DiskAction *string `json:"diskAction,omitempty" tf:"disk_action,omitempty"`
	...
	// A reference to a virtualizationBaseVirtualDisk resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Inventory []InventoryParameters `json:"inventory,omitempty" tf:"inventory,omitempty"`
	...
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	Parent []VirtualDiskParentParameters `json:"parent,omitempty" tf:"parent,omitempty"`

	// An array of relationships to moBaseMo resources.
	// +kubebuilder:validation:Optional
	PermissionResources []VirtualDiskPermissionResourcesParameters `json:"permissionResources,omitempty" tf:"permission_resources,omitempty"`

	// A reference to a assetDeviceRegistration resource.
	// When the $expand query parameter is specified, the referenced resource is returned inline.
	// +kubebuilder:validation:Optional
	RegisteredDevice []VirtualDiskRegisteredDeviceParameters `json:"registeredDevice,omitempty" tf:"registered_device,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Tags []VirtualDiskTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`

	// The versioning info for this managed object.
	// +kubebuilder:validation:Optional
	VersionContext []VirtualDiskVersionContextParameters `json:"versionContext,omitempty" tf:"version_context,omitempty"`

	// Iops (input-output operations per sec) info for the volume.
	// +kubebuilder:validation:Optional
	VolumeIopsInfo []VolumeIopsInfoParameters `json:"volumeIopsInfo,omitempty" tf:"volume_iops_info,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Zone []ZoneParameters `json:"zone,omitempty" tf:"zone,omitempty"`
}

type VirtualDiskParentObservation struct {
}

type VirtualDiskParentParameters struct {
...
type VirtualDiskPermissionResourcesObservation struct {
}

type VirtualDiskPermissionResourcesParameters struct {
...
type VirtualDiskRegisteredDeviceObservation struct {
}

type VirtualDiskRegisteredDeviceParameters struct {
...
type VirtualDiskTagsObservation struct {
}

type VirtualDiskTagsParameters struct {
...
type VirtualDiskVersionContextInterestedMosObservation struct {
}

type VirtualDiskVersionContextInterestedMosParameters struct {
...
type VirtualDiskVersionContextObservation struct {
}

type VirtualDiskVersionContextParameters struct {
	...
	// +kubebuilder:validation:Optional
	InterestedMos []VirtualDiskVersionContextInterestedMosParameters `json:"interestedMos,omitempty" tf:"interested_mos,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RefMo []VirtualDiskVersionContextRefMoParameters `json:"refMo,omitempty" tf:"ref_mo,omitempty"`
...
type VirtualDiskVersionContextRefMoObservation struct {
}

type VirtualDiskVersionContextRefMoParameters struct {
...
type VolumeIopsInfoObservation struct {
}

type VolumeIopsInfoParameters struct {
	...
	// +kubebuilder:validation:Optional
	IopsReadLimit *int64 `json:"iopsReadLimit,omitempty" tf:"iops_read_limit,omitempty"`

	// Number of disk write commands that can be performed per second.
	// +kubebuilder:validation:Optional
	IopsWriteLimit *int64 `json:"iopsWriteLimit,omitempty" tf:"iops_write_limit,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ThroughputReadLimit *int64 `json:"throughputReadLimit,omitempty" tf:"throughput_read_limit,omitempty"`

	// Data transfer rate limit to the disk, specified in mebibytes (MiB) per second.
	// +kubebuilder:validation:Optional
	ThroughputWriteLimit *int64 `json:"throughputWriteLimit,omitempty" tf:"throughput_write_limit,omitempty"`
}
...
// VirtualDiskStatus defines the observed state of VirtualDisk.
type VirtualDiskStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualDiskObservation `json:"atProvider,omitempty"`
}
...
var (
	VirtualDisk_Kind             = "VirtualDisk"
	VirtualDisk_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualDisk_Kind}.String()
	VirtualDisk_KindAPIVersion   = VirtualDisk_Kind + "." + CRDGroupVersion.String()
	VirtualDisk_GroupVersionKind = CRDGroupVersion.WithKind(VirtualDisk_Kind)
)
