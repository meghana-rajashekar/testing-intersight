...
type LocalClientsObservation struct {
}

type LocalClientsParameters struct {
	...
	// +kubebuilder:validation:Optional
	MinSeverity *string `json:"minSeverity,omitempty" tf:"min_severity,omitempty"`
...
type PolicyParameters struct {
	...
	// +kubebuilder:validation:Optional
	LocalClients []LocalClientsParameters `json:"localClients,omitempty" tf:"local_clients,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RemoteClients []RemoteClientsParameters `json:"remoteClients,omitempty" tf:"remote_clients,omitempty"`
...
type RemoteClientsObservation struct {
}

type RemoteClientsParameters struct {
